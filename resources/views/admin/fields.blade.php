        ...
        <div class="fields-form">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="capacity" class="form-input" min="1" placeholder="Contoh: 10">
                </div>

                <div class="form-group full-width">
                    <label class="form-label">Foto Lapangan <span class="optional">(wajib)</span></label>
...
<script>
    ...
    function resetForm() {
        ['id', 'name', 'type', 'price', 'capacity', 'description'].forEach(id => {
    ...
    function load() {
        fetch('/api/fields')
            ...
            .then(fields => {
                ...
                if (fields.length === 0) {
                    html = '<tr><td colspan="9" class="empty-state">Belum ada data lapangan</td></tr>';
                } else {
                    fields.forEach(f => {
                        fieldsCache[f.id] = f;
    ...
    function save() {
        ...
        if (!name || !type || !price || !capacity || capacity < 1) {
            showAlert('Nama, jenis, harga, kapasitas, dan foto wajib diisi!', 'warning');
            return;
        }

        if (fotoInput.files.length === 0 && !document.getElementById('id').value) {
            showAlert('Foto lapangan wajib diisi!', 'warning');
            return;
        }
